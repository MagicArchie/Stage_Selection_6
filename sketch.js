...
function preload() {
  ...
  for (let i = 0; i < stageCount; i++) {
    const imagePath = `materials/images/Stg_${i + 1}F.png`;
    try {
...
function setup() {
  ...
  for (let i = 0; i < stageCount; i++) {
    ...
    stages.push({
      ...
      interactive: i < 6 // Set interactivity to true for the first six nodes, false for others
    });
  }
...
// Example: To turn off interactivity for all nodes except the first six
